...
def add_model_config_args(parser):
    """Model arguments"""
    parser.add_argument("-w", "--webglm_ckpt_path", type=str, default="THUDM/WebGLM-2B", help="path to the webglm checkpoint, default to $WEBGLM_CKPT or THUDM/WebGLM")
    
    parser.add_argument("-r", "--retriever_ckpt_path", type=str, default="THUDM/webglm-contriever", help="path to the retriever checkpoint, default to $WEBGLM_RETRIEVER_CKPT")
    ...
    parser.add_argument("--searcher", type=str, default="bing", help="searcher to use (serpapi or bing), default to serpapi")
